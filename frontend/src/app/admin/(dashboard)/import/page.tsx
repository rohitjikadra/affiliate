...
export default async function AdminImportPage() {
  ...
  return (
    <section>
      <h2 className="text-xl font-semibold text-navy">Import products</h2>
      <p className="mt-1 mb-6 text-sm text-neutral-500">
        Paste ASINs or search Amazon. Matches reuse the existing product by ASIN. New rows stay Draft until you
        publish.
      </p>
